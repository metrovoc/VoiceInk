...
struct OnboardingTrustScreen: View {
    ...
    var body: some View {
        OnboardingStepScreen(
            ...
            subtitle: "Review how VoiceInk CE handles your data before you start.",
...
private struct TrustHeader: View {
    var body: some View {
        VStack(spacing: 16) {
            ...
            Text("VoiceInk CE is private by default")
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 10) {
                ...
                Text("VoiceInk CE is also open source, so you can inspect every single line of code.")
                    .font(.system(size: 13))
