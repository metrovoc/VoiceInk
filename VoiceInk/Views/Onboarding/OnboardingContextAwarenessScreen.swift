...
struct OnboardingContextAwarenessScreen: View {
    ...
    var body: some View {
        OnboardingStepScreen(
            ...
            title: "VoiceInk CE is Context-Aware",
            subtitle: "VoiceInk CE automatically understands what you are working with and selects your preferred setup.",
    ...
    var body: some View {
        ZStack {
            VStack(spacing: 18) {
                ...
                VStack(spacing: 10) {
                    Text("VoiceInk CE is context-aware.")
                    ...
                    Text("VoiceInk CE automatically understands what you are working with and selects your preferred setup. You can always configure this by editing or creating new modes.")
                        .font(.system(size: 15))
...
private struct ContextAwarenessCenterSlot: View {
    var body: some View {
        ContextAwarenessModeVisual()
            ...
            .accessibilityLabel("VoiceInk CE modes include Dictation, Enhance, Email, Assistant, Rewrite, Ask, Summarize, and Translate.")
    }
}
