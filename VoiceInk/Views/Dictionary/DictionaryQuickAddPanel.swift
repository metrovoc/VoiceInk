    ...
    private var vocabularyInput: some View {
        HStack(spacing: 11) {
            Image(systemName: "character.book.closed.fill")
                ...
                TextField("", text: $wordInput, prompt: Text("e.g. my name, VoiceInk CE").foregroundColor(.secondary))
        ...
        VStack(spacing: 8) {
            ...
            HStack(spacing: 10) {
                Text("With")
                    ...
                    .foregroundStyle(.secondary)
                    .frame(width: 56, alignment: .trailing)
                TextField("", text: $replacementInput, prompt: Text("e.g. hello@example.com").foregroundColor(.secondary))
                    .textFieldStyle(.roundedBorder)
                    .font(.system(size: 14))
