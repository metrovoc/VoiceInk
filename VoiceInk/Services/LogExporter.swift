...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "com.metrovoc.voiceink", category: "LogExporter")
    private let subsystem = "com.metrovoc.voiceink"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== VoiceInk CE Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "VoiceInk_CE_Logs_\(timestamp).log"
