...
final class SoundPlaybackEngine: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.metrovoc.voiceink.soundPlayback", qos: .userInitiated)
    private let logger = Logger(subsystem: "com.metrovoc.voiceink", category: "SoundPlaybackEngine")
